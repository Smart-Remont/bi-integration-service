...
class RequestStatusInfoService(BaseService):
    def __init__(self, repository: "RequestStatusInfoRepository") -> None:
    ...
    async def request_status_info(
        ...
        try:
            row = await self.repository.ddu_request_and_status_info(
